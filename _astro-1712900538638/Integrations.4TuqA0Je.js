        ...
        setup(r, {
            ...
            const e = r,
                ...
                c = _(() => {
                    ...
                    const u = e.siteMeta.whatsAppMessage ? `?text=${e.siteMeta.whatsAppMessage}` : "";
...
function A(r, s, e, t, c, o) {
    return a(), p("div", null, [t.facebookMessengerId ? (a(), C(t.FacebookMessenger, {
        key: 0,
        "facebook-messenger-id": t.facebookMessengerId
    }, null, 8, ["facebook-messenger-id"])) : i("", !0), t.whatsAppUrl ? (a(), p("a", {
        key: 1,
